...
\usepackage[scaled=0.85]{beramono} % Định hình font chữ monospace cho đẹp và cân đối
\usepackage{array} % Tạo bảng array
\usepackage[table]{xcolor} % Tô màu cho bảng biểu
\usepackage{tabularx} % Tạo bảng tự co giãn theo chiều rộng trang
\usepackage{longtable} % Tạo bảng dài có thể ngắt qua nhiều trang
