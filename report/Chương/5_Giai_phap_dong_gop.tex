...
Trong thiết kế HustFlow, mọi phản hồi từ dịch vụ AI được xem là dữ liệu đầu vào bên ngoài. Đối với các luồng có thể dẫn tới thay đổi dữ liệu, hệ thống không ghi trực tiếp phản hồi của mô hình mà thực hiện kiểm tra và yêu cầu người dùng xác nhận. Các trường hợp được kiểm soát bằng quy tắc tất định gồm phản hồi sai cấu trúc JSON, định danh không thuộc bảng, đề xuất gán việc cho thành viên không thuộc tập có thể nhận việc, chẳng hạn người có vai trò \texttt{VIEWER}, và ngày không hợp lệ. Đối với báo cáo AI, hệ thống giới hạn ngữ cảnh đầu vào, yêu cầu mô hình không tạo thông tin ngoài ngữ cảnh và kiểm tra cấu trúc phản hồi; tuy nhiên, cài đặt hiện tại chưa xác minh ngữ nghĩa từng nhận định hoặc số liệu trong báo cáo. Vì vậy, cơ sở dữ liệu và các quy tắc nghiệp vụ tại máy chủ vẫn là nguồn dữ liệu chuẩn, còn đầu ra AI cần được người dùng rà soát trước khi sử dụng.
...
Đồ án chưa thực hiện nghiên cứu người dùng để đo thời gian nhập liệu, tỷ lệ chấp nhận đề xuất hoặc chất lượng nội dung. Kết quả ngôn ngữ vẫn phụ thuộc vào mô hình, prompt và dữ liệu đầu vào. Riêng với báo cáo AI, kiểm tra Zod chỉ xác nhận cấu trúc và giới hạn của phản hồi, không chứng minh tính đúng đắn của từng nhận định hoặc số liệu; mô hình vẫn có thể diễn giải sai hoặc đưa ra kết luận chưa được dữ liệu chứng minh đầy đủ. Vì vậy, người dùng cần rà soát nội dung trước khi lưu hoặc sử dụng trong báo cáo.
