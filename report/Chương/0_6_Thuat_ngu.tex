...
\begin{longtable}{|p{4.2cm}|p{9.7cm}|}
    ...
    \textbf{Board member role} & Vai trò thành viên ở cấp bảng: \texttt{ADMIN} quản trị bảng và thành viên; \texttt{MEMBER} được chỉnh sửa nội dung; \texttt{VIEWER} (thành viên quan sát) chỉ được xem dữ liệu. \\ \hline
